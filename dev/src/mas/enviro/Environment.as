...
<<<<<<< HEAD
					BioAgent(e.agent).enqueueAction(new BioAgent_Die(BioAgent(e.agent), 10 * Config.t));	
=======
					BioAgent(e.agent).enqueueAction(new BioAgent_Die(BioAgent(e.agent), 8 * Config.t));	
